 ...
 * @api public
 */
function editableboolean (list, path, options) {
	this._nativeType = Boolean;
	this._properties = ['indent'];
	this._fixedSize = 'full';
	this.indent = (options.indent) ? true : false;
	editableboolean.super_.call(this, list, path, options);
}
editableboolean.properName = 'EditableBoolean';
util.inherits(editableboolean, FieldType);

editableboolean.prototype.defaults = {
	default: false,
};

editableboolean.prototype.validateInput = function (data, callback) {
...
editableboolean.prototype.validateRequiredInput = function (item, data, callback) {
	var value = this.getValueFromData(data);
 ...
 */
editableboolean.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 * Deprecated
 */
editableboolean.prototype.inputIsValid = function (data, required) {
	if (required) {
 ...
 */
editableboolean.prototype.updateItem = function (item, data, callback) {
	var value = this.getValueFromData(data);
