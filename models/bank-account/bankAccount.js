...
BankAccount.add({
	...
	smartPaySupport: { type: Types.MultiSelect, options: 'Apple Pay, Goolge Wallet, Samsung Pay, Tap and Go' },
	debitCardTypes: { type: Types.Select, options: 'Visa, Master Card, Others' },
