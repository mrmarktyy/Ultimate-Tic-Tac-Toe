...
describe('Personal Loan Comparison Rate Calculator', function() {

	describe('Without intro term', function() {
		it('Should return the exact Comparison Rate', function() {
			let cr = ComparisonRateCalculator.calculatePersonalLoanComparisonRate(4.5, 0, 0, 52, 0, 100, 20)
			assert.equal(cr, 6.88);
		});
	});

	describe('With intro term', function() {
		it('Should return the exact Comparison Rate', function() {
...
describe('Car Loan Comparison Rate Calculator', function() {
