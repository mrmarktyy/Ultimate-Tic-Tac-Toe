...
exports = module.exports = function (app) {
  ...
  app.get('/api/redirects', keystone.middleware.api, routes.api.redirects.list)
  ...
  //product tallies
  app.get('/api/product-tallies', keystone.middleware.api, routes.api.productTallies.list)
}
